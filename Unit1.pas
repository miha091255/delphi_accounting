...
begin
  ...
  if Grades.Checked then
    ...
    'Как выставить баллы: https://disk.yandex.ru/i/O3RnKnGL9210rg'+#13;
  if Registration.Checked then
    s := s + 'Ваше заявление зарегистрировано. Добавьте согласия, как описано в инструкции:'+#13+
  'https://disk.yandex.ru/i/KN21P_7QknZHOQ'+#13;
  s := s + 'Если у вас остались вопросы, вы можете задать их '+questAddress;
  memo1.Text := s;
end;
